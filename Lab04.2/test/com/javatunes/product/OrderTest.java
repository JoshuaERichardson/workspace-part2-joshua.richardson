...
public class OrderTest {
    ...
    public void testProcessCart() {
        ...
        assertEquals(60.0,order1.processCart(productCart.allItems()),0.001);
        assertEquals(20.0,order1.processCart(musicCart.allItems()),0.001);
        assertEquals(50.0,order1.processCart(mediaCart.allItems()),0.001);
    }
}